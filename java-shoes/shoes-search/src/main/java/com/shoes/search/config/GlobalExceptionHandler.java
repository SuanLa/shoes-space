...
public class GlobalExceptionHandler {
    ...
    public ResultVO<String> methodArgumentNotValidHandler(Exception e) {
        ...
        return ResultVO.validateFailed(data);
    }
    ...
    public ResultVO<String> constraintViolationHandler(Exception e) {
        String field = "";
        String msg = "";
        ...
        return ResultVO.validateFailed("[" + field + "]" + msg);
    }
}
